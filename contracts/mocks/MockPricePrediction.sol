...
contract MockPricePrediction is Ownable, Pausable {
    ...
    modifier onlyOperator() {
        require(msg.sender == operatorAddress, "PricePrediction: operator only function");
        _;
    }

    modifier onlyAdminOrOperator() {
        require(msg.sender == adminAddress || msg.sender == operatorAddress, "PricePrediction: admin | operator only function");
        _;
    }
